...
| React-Foundations | 5 | `react/react-foundations` |
...
| Dynamic-Toggle-Button | 7 | `mini-projects/dynamic-toggle-button` |
| Dynamic-List-Creator | 6 | `mini-projects/dynamic-list-creator` |
| Cat-Viewer-API | 4 | `mini-projects/cat-viewer-api` |
| user-card-freeapi | 5 | `mini-projects/user-card-freeapi` |
| Jokes-Viewer-Application | 4 | `mini-projects/jokes-viewer` |
| Quotes-Listing-Application | 5 | `mini-projects/quotes-listing` |
| Meals-Listing-Interface-API | 5 | `mini-projects/meals-listing` |
| predefined-chatbot | 1 | `mini-projects/predefined-chatbot` |
| personal-chatbot-AI | 2 | `mini-projects/personal-chatbot-ai` |
| TimeIt | 15 | `mini-projects/timeit` |
| kanban-Board | 11 | `mini-projects/kanban-board` |
| currency-converter | 18 | `mini-projects/currency-converter` |
